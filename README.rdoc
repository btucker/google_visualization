...
A helper Ruby library for the {Google Visualization API}[http://code.google.com/apis/visualization/].
    ...
    <head>
      ...
      <script type="text/javascript">
        ...
        function drawChart() {
          ...
          var data = new google.visualization.DataTable(<%= data_table.dump(:json) %>);
